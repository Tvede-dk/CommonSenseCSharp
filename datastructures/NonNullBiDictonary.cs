...
namespace CommonSenseCSharp.datastructures
{
        ...
        IDictionary
    {
            ...
            IDictionary
        {
            ...
            public ReverseDictionary(NonNullBiDictionary<TFirst, TSecond> owner)
            {
                _owner = owner;
            }
        ...
        [CanBeNull]
        public TSecond GetValueSafe([NotNull] TFirst first)
        {
            return _firstToSecond.ContainsKey(first) ? _firstToSecond[first] : default(TSecond);
        }

        [CanBeNull]
        public TFirst GetKeySafe([NotNull] TSecond second)
        {
            return _secondToFirst.ContainsKey(second) ? _secondToFirst[second] : default(TFirst);
        }
    }
